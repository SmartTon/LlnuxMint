...
public class FacePlaceCrystalAura extends Module {
    public enum Mode {
        Safe,
        Suicide
    }
    ...
    public FacePlaceCrystalAura() {
        super(Categories.ExtraLint, "FacePlaceCrystalAura", "Automatically places and breaks crystals to damage other players.");
    }
