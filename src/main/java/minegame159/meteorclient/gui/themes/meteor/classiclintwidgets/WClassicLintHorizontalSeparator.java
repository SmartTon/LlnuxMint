...
public class WClassicLintHorizontalSeparator extends WHorizontalSeparator implements ClassicLintWidget {
    public WClassicLintHorizontalSeparator(String text) {
        super(text);
    }
