...
public class WClassicLintDropdown<T> extends WDropdown<T> implements ClassicLintWidget {
    public WClassicLintDropdown(T[] values, T value) {
        super(values, value);
    }
    ...
    private static class WRoot extends WDropdownRoot implements ClassicLintWidget {
        @Override
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            CustomLintTheme theme = theme();
    ...
    private class WValue extends WDropdownValue implements ClassicLintWidget {
        @Override
