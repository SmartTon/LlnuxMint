...
public class ChatUtils {
    ...
    private static BaseText getPrefix(String title, PrefixType type) {
        ...
        if (Config.get().rainbowPrefix) {
            meteor.append(new LiteralText("L").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
            meteor.append(new LiteralText("i").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
            meteor.append(new LiteralText("n").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
            meteor.append(new LiteralText("u").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
            meteor.append(new LiteralText("x").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
            meteor.append(new LiteralText(" ").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
            meteor.append(new LiteralText("L").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
            meteor.append(new LiteralText("i").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
            meteor.append(new LiteralText("n").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
            meteor.append(new LiteralText("t").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
        } else {
            meteor = new LiteralText("Linux Lint");
